...
### `__init__(self, d_model: int, num_sub_experts: int = 4, max_seq_len: int = 1024, expert_type: str = 'general', dropout: float = 0.1)`
...
### `entropy(self, distribution: torch.Tensor) -> torch.Tensor`
